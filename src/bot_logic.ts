...
Сформируй жесткую сводку СТРОГО в таком формате:

Артем, сводка.

В Лукьяновке [температура и погода]. [Суровая рекомендация по экипировке]. [Жесткая мысль о погоде и продуктивности].

Курсы: USD/UAH — [курс доллара]. Bitcoin — [курс битка].

Мотивация: [2-3 жестких предложения в стиле Дэвида Гоггинса. Никакой жалости к себе.]`;
